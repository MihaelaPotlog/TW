...
<body>
    ...
    <div id='allAlerts' class='allAlerts'>
        <div id='fire' class='alerts'><a href="formularAlerte.php?tipalerta=<?php echo 'FIRE' ?>" ><img src='img/fire.png' alt="fire icon"></a></div>
        <div id='person' class='alerts'><a href="formularAlerte.php?tipalerta=<?php echo 'TORNADO' ?>"><img src='img/person.png' alt="person icon"></a></div>
        <div id='inundation' class='alerts'><a href="formularAlerte.php?tipalerta=<?php echo 'INUNDATION' ?>"><img src='img/inundation.png' alt="inundation icon"></a></div>
        <div id='earthquake' class='alerts'><a href="formularAlerte.php?tipalerta=<?php echo 'EARTHQUAKE' ?>"><img src='img/earthquake.png' alt="eartq icon"></a></div>
    </div>
