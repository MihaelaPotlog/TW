...
<head>
    <link href="formularAlerteAutoritati.css" rel="stylesheet" type="text/css">
</head>
...
<body>
    ...
    <div id="formular">
        ...
        <form id="formAutoritati">
            ...
            <input type="text" name="tipalerta" id="event" class="textField" value="<?php echo $_GET["tipalerta"]; ?>" ; />
